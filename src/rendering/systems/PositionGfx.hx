...
class PositionGfx implements ISystem
{
	...
	public function update(gfx:Gfx, body:Body) 
	{
		...
		gfx.display.x = Math.round(pos.x * B2.worldScale / RenderingConf.PIXEL_SIZE) * RenderingConf.PIXEL_SIZE;
		gfx.display.y = Math.round(pos.y * B2.worldScale / RenderingConf.PIXEL_SIZE) * RenderingConf.PIXEL_SIZE;
